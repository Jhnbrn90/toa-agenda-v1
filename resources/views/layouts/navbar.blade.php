    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        ...
        @if(Route::currentRouteName() == "home" OR Route::currentRouteName() == "taskDate")
          <a href="/filter" class="btn btn-outline-info" title="Laat enkel door mij aangevraagde verzoeken zien.">Mijn overzicht</a>
        @elseif(Route::currentRouteName() == "taskFilter" OR Route::currentRouteName() == "taskFilterDate")
          <a href="/" class="btn btn-info" title="Laat alles zien.">Mijn overzicht</a>
        @endif
      </li>
    </ul>
        <div style="margin-right: 20px;">
          <form method="POST" action="/date/search" class="form-inline my-1 my-lg-0" style="font-family: sans-serif;">
            ...
            <button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Naar datum</button>
          </form>
        </div>
